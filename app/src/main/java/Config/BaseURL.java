...
public class BaseURL {
    static final String APP_NAME = "Blanjan";
    ...
    public static String BASE_URL = "http://admin.belanjan.com/";
    ...
    public static String GET_FREE_ONGKIR = BASE_URL + "index.php/api/free_ongkir";
