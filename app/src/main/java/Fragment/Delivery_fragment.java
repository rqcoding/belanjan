...
public class Delivery_fragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (ConnectivityReceiver.isConnected()) {
            ...
            makeGetFreeOngkir(BaseURL.GET_FREE_ONGKIR);
    ...
    private BroadcastReceiver mCart = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (type.contentEquals("update")) {
                ...
                int totalA=Integer.parseInt(db_cart.getTotalAmount());
                int deliCharge=Integer.parseInt(deli_charges);
                if (totalA>=free_ongkir){
                    deli_charges=Integer.toString(0);
                }
    ...
    private void makeGetFreeOngkir(String url) {
        ...
        JsonObjectRequest jsonObjReq = new JsonObjectRequest(Request.Method.GET,
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    free_ongkir=response.getInt("free_ongkir");
