...
import com.belanjan.LoginActivity;
...
import static Config.BaseURL.KEY_LAT;
import static Config.BaseURL.KEY_LNG;
...
public class Session_management {
    ...
    public HashMap<String, String> getUserDetails() {
        ...
        user.put(KEY_LAT, prefs.getString(KEY_LAT, null));
        user.put(KEY_LNG, prefs.getString(KEY_LNG, null));
    ...
    public void updateAlamat(String name) {

        editor.putString(KEY_HOUSE, name);

        editor.apply();
    }

    public void updateSocity(String socity_name, String socity_id,String lat,String lng) {
        editor.putString(KEY_SOCITY_NAME, socity_name);
        editor.putString(KEY_SOCITY_ID, socity_id);
